...
//  	CORE_ATOMIC_IRQ_DISABLE();
//  //	flag = GPIO_IntGet();
//  	status_pb0 = GPIO_PinInGet(gpioPortF,6);
//  	if (status_pb0==0)
//  	{
//  		button=1;
//  		gecko_cmd_sm_passkey_confirm(val,1);
//  //		gecko_external_signal(button);
//  //		gecko_cmd_gatt_server_send_characteristic_notification(connection_all, gattdb_button_state, 1, (const uint8*)&button);
//  	}
//  	else
//  	{
//  		button=0;
//  //		gecko_external_signal(button);
//  //		gecko_cmd_gatt_server_send_characteristic_notification(0xFF, 11, 1, (const uint8*)&button);
//  	}
//  		//	uint32_t status = GPIO_IntGet();
//  //	button|=PB0_PRESSED;						//button pressed
//  //	gecko_external_signal(button);   //external signal bluetooth event
//  	GPIO_IntClear(status_pb0);
//  	CORE_ATOMIC_IRQ_ENABLE();
//}
